<?php $sum=0; foreach ($_SESSION['fotos'] as $im): //Para saber cuantas veces debe crearse un modal con igual "ID" que el boton que los llama?>
<!-- Modal -->
<div class="modal fade" id="modImg<?php echo $sum+=1 ?>" tabindex="-1" role="dialog" aria-labelledby="..." aria-hidden="true">
    ...
    <div class="modal-content">
      <div class="modal-header">
        ...
        <div class="modal-body">
        	<form class="" novalidate action="?controller=galeria&action=modificarFoto&idI=<?php echo $im->id; ?>" method="POST">
