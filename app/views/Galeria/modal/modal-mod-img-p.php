<?php $sum=0; foreach ($_SESSION['fotos'] as $im ): if($im->tipo==2): //Para saber cuantas veces debe crearse un modal con igual "ID" que el boton que los llama?>
<!-- Modal -->
<div class="modal fade" id="modImg-p<?php echo $sum+=1 ?>" tabindex="-1" role="dialog" aria-labelledby="..." aria-hidden="true">
